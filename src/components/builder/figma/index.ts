 ...
 *
 * These components are generated from the Figma Whitelabel Master File
 * and use CSS variables for multi-brand theming.
 */

export { FigmaButton } from "./Button";
...
// Re-export types
export type { FigmaButtonProps } from "./Button";
